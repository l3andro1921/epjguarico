<div class="row justify-content-center">
    <div class="col-md-12">
        ...
        {!! Form::open(['route' => ['perfil.update', $datos->id], 'method' => 'PUT']) !!}
            ...
            <div class="col-md-4">
                <div class="card bg-gradient-lightblue">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Sexo</label>
                            {!! Form::select('sexo', ['Femenino' => 'Femenino', 'Masculino' => 'Masculino'], $datos->sexo, ['class' => 'form-control']) !!}
                        </div>
                        <div class="form-group">
                ...
                <div class="card bg-gradient-lightblue">
                    ...
                    <div class="card-body">
                        <div class="input-group">
                            ...
                            {!! Form::text('nombre_grupo', $datos->nombre_grupo, ['class' => 'form-control', 'placeholder' => 'Grupo Juvenil']) !!}
                        </div>
                        <div class="form-group">
                ...
                <div class="card bg-gradient-lightblue">
                    ...
                    <div class="card-body">
                        <div class="input-group">
                            ...
                            {!! Form::text('referencia', $datos->referencia, ['class' => 'form-control', 'placeholder' => '¿Quien te Invito?']) !!}
                        </div>
                        <div class="form-group">
                            <label>¿Que te Motivo?</label>
                            {!! Form::text('motivo_registro', $datos->motivo_registro, ['class' => 'form-control', 'placeholder' => '¿Que te Motivo?']) !!}
                        </div>
