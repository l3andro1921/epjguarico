                ...
                <div class="card bg-gradient-lightblue">
                    ...
                    <div class="card-body">
                        <div class="input-group">
                            ...
                            {!! Form::text('nombre_grupo', null, ['class' => 'form-control', 'placeholder' => 'Grupo Juvenil']) !!}
                        </div>
                        <div class="form-group">
                ...
                <div class="card bg-gradient-lightblue">
                    ...
                    <div class="card-body">
                        <div class="input-group">
                            ...
                            {!! Form::text('referencia', null, ['class' => 'form-control', 'placeholder' => '¿Quien te Invito?']) !!}
                        </div>
                        <div class="form-group">
                            <label>¿Que te Motivo?</label>
                            {!! Form::text('motivo_registro', null, ['class' => 'form-control', 'placeholder' => '¿Que te Motivo?']) !!}
                        </div>
