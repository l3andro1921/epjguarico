        ...
        <div class="offset-1 col-md-5">
            ...
            <div class="card card-success">
                <div class="card-header">
                    <h3 class="card-title">Nuevo Tipo de Evento</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                {!! Form::open(['route' => 'configuracion.store', 'method' => 'POST', 'role' => 'form']) !!}
                <div class="card-body">

                    <div class="form-group">
                        <label for="name">Tipo de Evento</label>
                        {!! Form::text('tipo_evento', null, ['class' => 'form-control', 'placeholder' => __('Name'), 'required']) !!}
                    </div>
                    <div class="form-group">
