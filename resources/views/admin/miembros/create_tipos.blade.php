...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">Nuevo Tipo Miembro</li>
@endsection
        ...
        <div class="col-md-3">
            ...
            <div class="card card-success">
                <div class="card-header">
                    <h3 class="card-title">Nuevo Tipo Miembro</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                {!! Form::open(['route' => 'miembros_tipos.store', 'method' => 'POST', 'role' => 'form']) !!}
                <div class="card-body">

                    <div class="form-group">
                        <label for="name">{{ __('Name') }} Tipo</label>
                        {!! Form::text('tipo_miembro', null, ['class' => 'form-control', 'placeholder' => __('Name'), 'required']) !!}
                    </div>
                </div>
                <!-- /.card-body -->
