...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">Editar Mensaje</li>
@endsection
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="col-md-12">
                ...
                {!! Form::open(['route' => ['agenda.update', $agenda->id], 'method' => 'PUT']) !!}

                <div class="row">
                    <div class="offset-3 col-md-6">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Editar Mensaje</h3>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('datos_id', $miembros, $agenda->datos_id, ['class' => 'form-control chosen-select',
                                                      'placeholder' => 'Seleccione']) !!}
                                </div>
                                <div class="form-group">
                                    <label>Mensaje</label>
                                    {!! Form::textarea('mensaje', $agenda->mensaje, ['class' => 'form-control',
