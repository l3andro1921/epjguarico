...
@section('title', 'Eventos | Asistencia')
                ...
                <div class="card card-widget widget-user-2">
                    ...
                    <div class="card-footer p-0">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item nav-link">
                                <span class="text-bold text-muted">Miembros Inscritos:</span>
                                <span class="float-right text-success text-bold">{{ $evento->confirmados }}</span>
                            </li>
                            <li class="nav-item nav-link">
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <div class="card-header border-0">
                        <h3 class="card-title">Miembros Inscritos</h3>
                    ...
                    <div class="card-body">
                        {!! Form::open(['route' => ['eventos.asistencia.update', $evento->id], 'method' => 'PUT', 'role' => 'form']) !!}
                        <div class="row">
                                            ...
                                            <div class="btn-group">
                                                                    ...
                                                                    <div class="card-footer p-0">
                                                                        <ul class="nav flex-column">
                                                                            ...
                                                                            <li class="nav-item nav-link">
                                                                                ...
                                                                                <span class="float-right text-primary">{{ $rango->telefono }}</span>
                                                                            </li>
                                                                            <li class="nav-item nav-link">
                                                                                <span class="text-bold text-muted">Sexo:</span>
                                                                                <span class="float-right text-primary">{{ $rango->sexo }}</span>
                                                                            </li>
                                                                            <li class="nav-item nav-link">
                                                                                <span class="text-bold text-muted">Parroquia:</span>
                                                                                <span class="float-right text-primary">{{ $rango->parroquia }}</span>
                                                                            </li>
                                                                            <li class="nav-item nav-link">
                                                                                <span class="text-bold text-muted">Arquidiosesis:</span>
                                                                                <span class="float-right text-primary">{{ $rango->arquidiosesis }}</span>
                                                                            </li>
                                                ...
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">
                                                        @if($rango->asistencia == "SI")
                                                            @php($opc = true)
                                                        @else
                                                            @php($opc = false)
                                                        @endif
                                                        {!! Form::checkbox('asistencia_'.$i, 'SI', $opc) !!}
                                                        <input type="hidden" name="id_{{ $i }}" value="{{ $rango->id }}">
                                                    </span>
                                                </div>
