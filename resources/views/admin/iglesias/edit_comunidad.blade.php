    ...
    <div class="row justify-content-center">
        <div class="col-md-4">
            ...
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                {!! Form::open(['route' => ['comunidades.update', $actual->id], 'method' => 'PUT', 'role' => 'form']) !!}
                <div class="card-body">

                    <div class="form-group">
                        <label for="name">Iglesia</label>
                        {!! Form::select('iglesias_id', $iglesias, $actual->iglesias_id, ['class' => 'form-control', 'placeholder' => 'Seleccione', 'required']) !!}
                    </div>
                    <div class="form-group">
                        <label for="name">{{ __('Name') }} de la Comunidad</label>
                        {!! Form::text('nombre_comunidad', $actual->nombre_comunidad, ['class' => 'form-control', 'placeholder' => __('Name'), 'required']) !!}
                    </div>
